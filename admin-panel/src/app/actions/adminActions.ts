      ...
      await MiniGameConfig.insertMany([
        {
          ...
          maxDailyPlays: 0,
          rewardTiers: [
            { id: "t1", pointThreshold: 5, rewardName: "Free Cookie", rewardDescription: "Any cookie from display" },
        ...
        },
        {
          ...
          rewardTiers: [
            ...
            { id: "t7", pointThreshold: 300, rewardName: "Free Combo Meal", rewardDescription: "Any combo from lunch menu" },
          ],
        },
      ]);
