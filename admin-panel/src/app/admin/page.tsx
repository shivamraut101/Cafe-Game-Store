                  ...
                  <div className="bg-gradient-to-r from-[#1A1A1A] to-[#2D2D2D] text-white rounded-3xl p-6 border-3 border-black shadow-[6px_6px_0px_0px_#FF4C29] flex flex-col lg:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <button
                        ...
                        className="py-3 px-4 bg-emerald-400 text-black rounded-2xl font-black text-xs border-2 border-black shadow-[3px_3px_0px_0px_#000] hover:translate-y-[1px] transition-all cursor-pointer"
                      >
                        1. CONFIGURE REWARDS 🎮
                      </button>
                      <button
                        onClick={() => setActiveTab("qr-studio")}
                        className="py-3 px-4 bg-[#FF4C29] text-white rounded-2xl font-black text-xs border-2 border-black shadow-[3px_3px_0px_0px_#000] hover:translate-y-[1px] transition-all cursor-pointer"
                      >
                        2. PRINT QR STANDS 📱
                      </button>
                    </div>
                        ...
                        <div key={game.id} className="flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl border-2 border-black bg-white hover:bg-black/[0.02] transition-colors gap-4">
                          ...
                          <div className="flex items-center gap-6">
                            ...
                            <button 
                              ...
                              className={`px-4 py-2 rounded-lg font-bold text-xs border-2 border-black shadow-[2px_2px_0px_0px_#000] hover:translate-y-[1px] hover:shadow-none transition-all w-24 cursor-pointer ${
